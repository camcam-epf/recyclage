...
public class FInscription extends javax.swing.JDialog {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(PCentre, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bValider)
                    .addComponent(bRetour))
    ...
    private void bValiderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bValiderActionPerformed
        ...
        if (cbUti.getSelectedIndex() == 0) {
            maPlat.inscriptionPart(email, mdp, nom, prenom, tel, adresse);
        }
        if (bValider.isSelected()) {
            if (email.isEmpty() == false && mdp.isEmpty() == false && nom.isEmpty() == false && prenom.isEmpty() == false && tel.isEmpty() == false && adresse.isEmpty() == false) {
                this.setVisible(false);
        ...
        try {
            switch (cbUti.getSelectedIndex()) {
                case 0:
                    ...
                    break;
                case 1:
                    maPlat.inscriptionEnt(email, mdp, nom, tel, adresse);
                    maPlat.sauvegarderClients();
                    break;
                case 2:
                    maPlat.inscriptionCentre(email, mdp, nom, tel, adresse, typeD, ouv, ferm, capacite);
